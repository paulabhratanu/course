...
<title>Execute PHP Online</title>
<meta name="Description" content="Execute PHP Online - Try and experience the best cloud computing where you can edit, compile, execute and share your varities of projects with the help of simple clicks. You can save your projects at Dropbox, GitHub, GoogleDrive and OneDrive to be accessed anywhere and any time. We support almost all the popular programming languages including Java, JSP, Cold Fusion, C, C++, Hadoop, PL/SQL, SQL, NumPy, SymPy, Octave, CentOS, iPython, Pascal, Fortran, PHP, Perl, Ruby, Python and many more other programming languages using your browsers, iPhones, iPads or any other online device like smart TV." />
<meta name="Keywords" content="Execute PHP Online, compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
var port = "6903";
var sessionid = "h3dk8p6jop4qhal2c5b6f108d5";
var HOME="http://codingground1.tutorialspoint.com";
var terminal="0";
</script>
...
<div data-options="region:'north'" style="height:65px; width:100%;overflow:hidden;background:url(/codingground/images/top_bg.png);">
   ...
   <h1 class="main-title">Execute PHP Online</h1>
...
<div id="east" data-options="region:'east',iconCls:'icon-library', title:'Tutorials', split:true" style="width:105px; border-left:5px solid #eee; overflow:hidden; background:#285627;">
   <a href="/html/index.htm" title="Learn HTML" target="_blank">
   <img style="width:100px; height:80px;" src="/images/html_icon.png" alt="Learn HTML"/>
   </a>
   <a href="/css/index.htm" title="Learn CSS" target="_blank">
   <img style="width:100px; height:80px;" src="/images/css_icon.png" alt="Learn CSS"/>
   </a>
   <a href="/javascript/index.htm" title="Learn Javascript" target="_blank">
   <img style="width:100px; height:80px;" src="/images/javascript_icon.png" alt="Learn Javascript"/>
   </a>
   <a href="/jquery/index.htm" title="Learn jQuery" target="_blank">
   <img style="width:100px; height:80px;" src="/images/jquery_icon.png" alt="Learn jQuery"/>
   </a>
   <a href="/php/index.htm" title="Learn PHP" target="_blank">
   <img style="width:100px; height:80px;" src="/images/php_icon.png" alt="Learn PHP"/>
   </a>
   <a href="/mysql/index.htm" title="Learn MySQL" target="_blank">
   <img style="width:100px; height:80px;" src="/images/mysql_icon.png" alt="Learn MySQL"/>
   </a>
</div>
